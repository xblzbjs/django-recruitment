...
from recruitment.jobs.models import DEGREE_TYPE
...
class Candidate(models.Model):
    ...
    first_interviewer_user = models.ForeignKey(AUTH_USER_MODEL, related_name='first_interviewer_user', blank=True, null=True, on_delete=models.CASCADE, verbose_name=u'面试官')
    ...
    second_interviewer_user = models.ForeignKey(AUTH_USER_MODEL, related_name='second_interviewer_user', blank=True, null=True, on_delete=models.CASCADE, verbose_name=u'二面面试官')
    ...
    hr_interviewer_user = models.ForeignKey(AUTH_USER_MODEL, related_name='hr_interviewer_user', blank=True, null=True, on_delete=models.CASCADE, verbose_name=u'HR面试官')
